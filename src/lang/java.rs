...
mod tests {
    ...
    fn line_comment_todo() {
        let parser = crate::lang::Parser::new("TODO", &JAVA);
        let text = r#"
class Example {
...
"#;
    ...
    fn todo_inside_double_quoted_string_ignored() {
        let parser = crate::lang::Parser::new("TODO", &JAVA);
        let text = r#"
String msg = "// TODO this should be ignored";
...
"#;
    ...
    #[test]
    fn todo_inside_text_block_ignored() {
        let parser = crate::lang::Parser::new("TODO", &JAVA);
        let text = r#"
class Example {
    String msg = """
        // TODO false positive
        /* TODO another false positive */
        """;
...
"#;
    ...
    fn inline_todo() {
        let parser = crate::lang::Parser::new("TODO", &JAVA);
        let text = r#"int value = 1; // TODO fix this
int other = 2;
"#;
        let todos = parser.parse_str(text);
        assert_eq!(todos.len(), 1);
